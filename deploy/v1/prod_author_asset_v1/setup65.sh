...
aws s3 cp s3://vx-tokyo/tmp/tei_work/prod_author_asset_v1/convert65/config.ini ./convert65/
aws s3 cp s3://vx-tokyo/tmp/tei_work/prod_author_asset_v1/convert65/convert_65.sh ./convert65/
